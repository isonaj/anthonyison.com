...
So who cares? I mean, I'm running on PaaS. I can change the number of servers with a slider, or set rules to automatically add and remove servers as my traffic changes. Isn't that good enough? Not according to [Troy Hunt](https://www.troyhunt.com). When your traffic spikes (like, when a million people pick up their phone at the same time and hit your site), you can go from "too much cloud" to "not enough cloud" very quickly.
